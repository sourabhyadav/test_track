...
def batch_standard_to_PoseTrack_17(dataset_split="light_track", mode="pose", bbox_thresh=0, drop_thresh=0):
    if dataset_split == "light_track":
        ...
        gt_json_folder_base = "/media/F/exp_2017-val/evaluation/annotations/val/"
        # 实验结果保存位置
        input_json_folder_base = "/media/F/exp_2017-val/jsons"
        output_json_folder_base = "/media/F/exp_2017-val/evaluation/posetrack_results"
